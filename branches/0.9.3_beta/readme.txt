...
= v0.9.3 =
* added a new layout option to the widgets preferences: you can create a list of all custom field values of one custom field (name). Each value can be linked individually to a post or a page or to something else.
